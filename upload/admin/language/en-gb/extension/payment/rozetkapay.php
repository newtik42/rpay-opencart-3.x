...
$_['button_log_refresh'] = 'Refresh';
$_['error_log_warning']	   = 'Warning: log file %s!';

$_['entry_send_info_customer_status'] = 'Send customer data';
$_['entry_send_info_products_status'] = 'product';

$_['text_tab_view'] = 'View';
$_['text_view_title_default'] = 'Use the default name';
$_['text_view_icon_status'] = 'Display logo';
$_['text_view_title'] = 'Title';
$_['error_title_empty'] = 'The number of characters must be between 5 and 80';

$_['text_help_test'] = 'The test mode will work only for those users who have previously entered the admin';





$_['error_currency_not_uah'] = 'There is no currency UAH on the site, without it the payment will not work correctly';
